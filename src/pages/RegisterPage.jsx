    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-[52%] brand-panel relative flex-col justify-between p-12 overflow-hidden">
        ...
        <div className="relative z-10 max-w-md">
          ...
          >
            Get access to campaigns, leads, and real-time analytics from day one.
          </motion.p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white">
        ...
        >
          ...
          <motion.div variants={stagger.item}>
            ...
            <p className="text-sm text-slate-500 mb-8">Start managing your campaigns today</p>
          </motion.div>

          <motion.form variants={stagger.item} onSubmit={handleSubmit} noValidate>
            {errors.form && (
            ...
            <Button type="submit" loading={loading} icon={User} className="w-full" size="lg">
              Create account
            </Button>
          </motion.form>
